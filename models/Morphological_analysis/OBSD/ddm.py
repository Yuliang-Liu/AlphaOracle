...
import OBSD_utils as utils
import OBSD_utils.misc as misc
from .unet import DiffusionUNet
import torch.distributed as dist
from torch.utils.tensorboard import SummaryWriter
from OBSD_utils.misc import NativeScalerWithGradNormCount as NativeScaler
import OBSD_utils.lr_sched as lr_sched
...
class DenoisingDiffusion(object):
    ...
    def sample_image(self, x_cond, x, last=True, patch_locs=None, patch_size=None):
        ...
        if patch_locs is not None:
            xs = utils.sampling.generalized_steps_overlapping(x, x_cond, seq, self.model, self.betas, eta=0.8,
