...
@MODELS.register_module()
class DinoTransformerOrderDecoder(DeformableDetrTransformerDecoder):

    def __init__(self, *args, **kwargs):
        super(DinoTransformerOrderDecoder, self).__init__(*args, **kwargs)
...
@MODELS.register_module()
class CoDinoOrderTransformer(CoDeformableDetrTransformer):

    def __init__(self, *args, **kwargs):
        super(CoDinoOrderTransformer, self).__init__(*args, **kwargs)
