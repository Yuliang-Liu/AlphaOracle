...
train_dataloader = dict(
    dataset=dict(data_root='/data/JGW/hsguan/mmpretrain/data/JGWN/', type=dataset_type, pipeline=train_pipeline),
    batch_size=64,
)

val_dataloader = dict(
    dataset=dict(data_root='/data/JGW/hsguan/mmpretrain/data/JGWN/', type=dataset_type, pipeline=test_pipeline),
    batch_size=64,
)
...
test_evaluator = dict(type='JGWMetric', topk=(1, 20), dl='/data/JGW/hsguan/mmpretrain/k2.txt')
