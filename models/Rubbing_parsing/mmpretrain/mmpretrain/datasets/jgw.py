...
from .categories import IMAGENET_CATEGORIES , JWG_C, JGWN, JGWN2
from .mycategories import JGW_f
from .jgwclass import data3, datal

from .custom import CustomDataset


@DATASETS.register_module()
class JGW(CustomDataset):
