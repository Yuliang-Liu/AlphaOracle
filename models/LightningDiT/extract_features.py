...
def main(args):
    ...
    for batch_idx, batch_data in enumerate(zip(*loaders)):
        ...
        for loader_idx, data in enumerate(batch_data):
            ...
            if rank == 0:
                print(f'Latent shape for batch {batch_idx} (loader {loader_idx}): {z.shape}')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default='path/train/source')
    parser.add_argument("--data_split", type=str, default='imagenet_train')
    parser.add_argument("--output_path", type=str, default="path/lantent/source")
